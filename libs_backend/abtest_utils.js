(function(){
  ...
  add_abtest('choose_difficulty_interface', ['this_intervention'], async function(chosen_algorithm){
    localStorage.setItem('choose_difficulty_interface', chosen_algorithm);
  });
  add_abtest('frequency_of_choose_difficulty', ['0.5'], async function(chosen_algorithm){
    localStorage.setItem('frequency_of_choose_difficulty', chosen_algorithm);
  });
  add_abtest('difficulty_selection_screen', ['nodefault_forcedchoice'], async function(chosen_algorithm){
  ...
  add_abtest('onboarding_ideavoting_abtest', ['off'], async function(chosen_algorithm){
    if (chosen_algorithm === 'off') {
